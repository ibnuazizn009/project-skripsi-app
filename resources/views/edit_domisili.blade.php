    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <small>Edit Data Domisili</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">Edit Data Domisili</li>
                </ol>
            </section>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    @foreach($domisili as $dom)
                                        <form action="/status-domisili/update/{{$dom->idx}}" method="POST">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                                <input type="hidden" value="{{ $dom->idx }}" class="form-control" id="exampleInputEmail1" name="idx">
                                            </div>
                                            <div class="form-group">
                                                <input type="hidden" value="{{ $dom->id_domisili }}" class="form-control" id="exampleInputEmail1" name="id_domisili">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" type="">Status Domisili</label>
                                                <input type="text" value="{{ $dom->status_domisili }}" required="required" class="form-control" placeholder="Wiraswasta" name="status_domisili">

                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-auto" style="padding: 5px;">
                                        <form action="/status-pekerjaan/add" method="POST">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" type="">ID Pekerjaane</label>
                                                <input type="text" required="required" class="form-control" placeholder="1" name="id_pekerjaan">
                                                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" type="">Jenis Pekerjaan</label>
                                                <input type="text" required="required" class="form-control" placeholder="Wiraswasta" name="jenis_pekerjaan">
                                                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                            </div>

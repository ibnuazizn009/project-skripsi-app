                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    @foreach($pekerjaan as $pj)
                                        <form action="/status-pekerjaan/update/{{$pj->idx}}" method="POST">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                                <input type="hidden" value="{{ $pj->idx }}" class="form-control" id="exampleInputEmail1" name="idx">
                                            </div>
                                            <div class="form-group">
                                                <input type="hidden" value="{{ $pj->id_pekerjaan }}" class="form-control" id="exampleInputEmail1" name="id_pekerjaan">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" type="">Jenis Pekerjaan</label>
                                                <input type="text" value="{{ $pj->jenis_pekerjaan }}" required="required" class="form-control" placeholder="Wiraswasta" name="jenis_pekerjaan">

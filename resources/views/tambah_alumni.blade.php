    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <small>Tambah Data Alumni</small>
                </h1>
                <ol class="breadcrumb">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-auto" style="padding: 5px;">
                                        <form action="/status_alumni/add" method="POST">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" type="">ID Status</label>
                                                <input type="text" required="required" class="form-control" placeholder="1" name="id_status">
                                                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" type="">Status Alumni</label>
                                                <input type="text" required="required" class="form-control" placeholder="Wiraswasta" name="status_alumni">
                                                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                            </div>

                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    @foreach($alumni as $alum)
                                        <form action="/status_alumni/update/{{$alum->idx}}" method="POST">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                                <input type="hidden" value="{{ $alum->idx }}" class="form-control" id="exampleInputEmail1" name="idx">
                                            </div>
                                            <div class="form-group">
                                                <input type="hidden" value="{{ $alum->id_status }}" class="form-control" id="exampleInputEmail1" name="id_status">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" type="">Status Alumni</label>
                                                <input type="text" value="{{ $alum->status_alumni }}" required="required" class="form-control" placeholder="Wiraswasta" name="status_alumni">

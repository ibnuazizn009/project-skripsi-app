...
<head>
    <meta charset="UTF-8">
    <title>Status Domisili Page</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            @can('create role')
                               <a href="/status-domisili/add" class="btn btn-sm btn-success" style="padding: 8px;"><b> Tambah Data </b></a>
                            @endcan
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                <div class="row">
                                        ...
                                        <table id="dtHorizontalVerticalExample"
                                            ...
                                            <tbody style="font-size: 14px">
                                                @foreach($domisili as $dom)
                                                    <tr>
                                                        <td>{{$dom->idx}}</td>
                                                        <td>{{$dom->id_domisili}}</td>
                                                        <td>{{$dom->status_domisili}}</td>
                                                        <td class="">
                                                            @can(['update role', 'delete role'])
                                                            <form onsubmit=""
                                                                method="POST">
                                                                <a href="/status-domisili/edit/{{$dom->idx}}" class="btn btn-sm btn-primary"><b>EDIT</b></a>
                                                                <a href="/status-domisili/delete/{{$dom->idx}}" class="btn btn-sm btn-danger"><b>HAPUS</b></a>
                                                            </form>
                                                            @endcan
                                                        </td>
                                                    </tr>

...
<body class="skin-blue">
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border" style="text-align: center;">
                                <h3 class="box-title">Grafik Wisudawan UIN SGD Bandung</h3>
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12" style="padding: 10px;">
                                        <div class="chart-responsive">
                                            <!-- this is chartJS -->
                                            <select class="form-control" onchange="renderChart(this)" style= "margin-left:20px!important; width:140px; border-color: #3c8dbc">
                                                <option value="jurusan_s1">Jurusan-S1</option>
                                                <option value="jurusan_s2">Jurusan-S2</option>
                                                <option value="fakultas">Fakultas</option>
                                            </select>
                                            
                                            <canvas id="myChart"></canvas>
                                            <!-- <canvas id="pieChart" width="100px" height="965px"></canvas> -->
                                            <!-- Sales Chart Canvas -->
                                        </div><!-- /.chart-responsive -->
                                    </div>
                                    <!--/.col -->
                                    <div class="col-md-8" style="padding: 10px; margin: -250px 0 0 280px;">
                                        <div class="chart-responsive">
                                            <!-- this is chartJS -->
    ...
    <script>
        // Fakultas
        var _ydataFakultas = {!! json_encode($fakultas_result) !!};
        var _xdataFakultas = {!! json_encode($result_jumlah) !!};

        // Jurusan S1
        var _ydataJurusan = {!! json_encode($result_join_jurusan) !!};
        var _xdataJurusan = {!! json_encode($result_join_jumlah ) !!};

         // Jurusan S2
         var _ydataJurusan_S2 = {!! json_encode($result_join_jurusan_S2) !!};
        var _xdataJurusan_S2 = {!! json_encode($result_join_jumlah_S2 ) !!};
    </script>

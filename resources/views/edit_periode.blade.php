    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <small>Edit Data Periode</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">Edit Data Periode</li>
                </ol>
            </section>
            ...
            <section class="content">
                ...
                <form action="/periode/update/{{$pd->idx}}" method="post">
                {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-auto" style="padding: 5px;">
                                                <div class="form-group">
                                                    <input type="hidden" value="{{ $pd->idx }}" class="form-control" id="exampleInputEmail1" name="idx">
                                                </div>
                                                <div class="form-group">
                                                    <input type="hidden" value="{{ $pd->id_periode }}" class="form-control" id="exampleInputEmail1" name="id_periode">
                                                </div>
                                                <div class="form-group">
                                                    <input type="hidden" value="{{ $pd->id_semester }}" class="form-control" id="exampleInputEmail1" name="id_semester">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1" type="">Periode</label>
                                                    <input type="text" value="{{ $pd->periode }}" required="required" class="form-control" placeholder="Wiraswasta" name="periode">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="date" name="tgl_buka_daftar" placeholder="MM-DD-YYY" type="text" value="{{$pd->tgl_buka_daftar}}"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label" for="date">Tanggal Pendaftaran di Tutup</label>
                                                    <input class="form-control" id="date" name="tgl_tutup_daftar" placeholder="MM-DD-YYY" type="text" value="{{$pd->tgl_tutup_daftar}}"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label" for="date">Tanggal Perpanjang di Tutup</label>
                                                    <input class="form-control" id="date" name="tgl_tutup_perpanjangan" placeholder="MM-DD-YYY" type="text" value="{{$pd->tgl_tutup_perpanjangan}}"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label" for="date">Tanggal Gladi</label>
                                                    <input class="form-control" id="date" name="tgl_gladi" placeholder="MM-DD-YYY" type="text" value="{{$pd->tgl_gladi}}"/>
                                                </div>
                                            </div>
                                            <!--/.col -->
                                        </div><!-- /.row -->
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-auto" style="padding: 5px;">
                                                <div class="form-group">
                                                    <label class="control-label" for="date">Tanggal Gladi</label>
                                                    <input class="form-control" id="date" name="tgl_bagi_toga" placeholder="MM-DD-YYY" type="text" value="{{$pd->tgl_bagi_toga}}"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label" for="date">Tanggal Pelaksanaan</label>
                                                    <input class="form-control" id="date" name="tgl_pelaksanaan" placeholder="MM-DD-YYY" type="text" value="{{$pd->tgl_pelaksanaan}}"/>
                                                </div>
                                                <div class="form-group">
                                                    <input type="hidden" value="{{ $pd->username }}" class="form-control" id="username_periode" name="username">
                                                </div>
                                                <div class="form-group">

                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            @can('create role')
                               <a href="/status-pekerjaan/add" class="btn btn-sm btn-success" style="padding: 8px;"> Tambah Data </a>
                            @endcan
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                <div class="row">
                                                ...
                                                @foreach($pekerjaan as $pk)
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            ...
                                                            <form onsubmit=""
                                                                method="POST">
                                                                <a href="/status-pekerjaan/edit/{{$pk->idx}}" class="btn btn-sm btn-primary">EDIT</a>

                                                                <a href="/status-pekerjaan/delete/{{$pk->idx}}" class="btn btn-sm btn-danger">HAPUS</a>
                                                            </form>
                                                            @endcan
                                                        </td>
                                                    </tr>
